...
LastEditTime: 2025-07-09 16:39:50
FilePath: /EngTestTool/pythonForFenics/fenics_solver.py
Description: 
...
if __name__ == "__main__":
    ...
    length = 1.0
    nx = 50
    # 布局：两个热源，分别在(0.3,0.3)和(0.7,0.7)，宽高0.2
    layout_list = [ (0.3, 0.3, 0.2, 0.2), (0.7, 0.7, 0.2, 0.2) ]
    powers = [10, 20]
